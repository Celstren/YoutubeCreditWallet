...
Widget _buildRaisedButton(
    ...
    return Padding(
      ...
      child: RaisedButton(
        elevation: 1.0,
        onPressed: () {
          var blockProviderCardCreate = BlocProvider(
            bloc: CardBloc(),
            child: CardCreate(),
          );

          blockProviderCardCreate.bloc.selectCardType(buttonText);

          Navigator.push(
              context, 
              MaterialPageRoute(builder: (context) => blockProviderCardCreate));
